...
function main() {
  ...
  console.time();
  fetch(
    "https://cdn.contentful.com/spaces/xo3l694rmh5a/environments/portafolio/entries?access_token=qKvjKKrhSXzFpjmdEojQ5-2dp54l-xjf4IGW-xds08A&content_type=portafolio&order=sys.createdAt"
  )
    .then((e) => {
      return e.json();
    })
